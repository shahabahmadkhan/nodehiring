angular.module('nodeHiring', []).
    config(['$routeProvider', function($routeProvider) {
        $routeProvider.
            ...
            when('/dashboard/admin/updateProfile', {templateUrl: 'view/updateProfile.html',   controller: UpdateProfileController}).
            when('/dashboard/user/updateProfile', {templateUrl: 'view/updateProfile.html',   controller: UpdateProfileController}).
